...
\section*{Соответствия из колонки В:}
\begin{enumerate}
...
\section*{Определите, к какой части речи относятся слова.}
\begin{enumerate}
...
\section{Exercise №12}
\section*{Match the words in column B with the correct definitions in column A:}
...
\section{Text 11 B}
\section*{New Materials That Could Change Our Lives}
...
\section{Exercise №14}
\section*{Read text 11 B again and answer the questions below choosing the best option according
...
\section{Exercise №27}
\section*{Replace the words in bold with their synonyms using the words given below. Translate the sentences into Russian.}
\begin{enumerate}
...
\section{Exercise №32}
\section*{Summarise in English using some key words from the vocabulary section.}
