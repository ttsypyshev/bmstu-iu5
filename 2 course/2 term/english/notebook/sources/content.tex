...
\chapter{Домашнее задание №10 16.05.24}
...
\section{Exercise №38}
\subsection*{Read the sentences (1-6) below and decide if the verbs in bold describe situations that are:}
\begin{enumerate}
...
\section{Exercise №44}
\subsection*{Questions for revision.}
\begin{enumerate}
...
\section{Exercise №46}
\subsection*{For each of the following sentences decide which option is correct. Identify the function
...
\section{Exercise №47}
\subsection*{In the sentences below fill in the blanks with a Present or Past Participle, a Gerund or
...
\section{Exercise №48}
\subsection*{Identify the forms of the underlined phrases and translate the sentences into Russian.}
\begin{enumerate}
...
\chapter{Домашнее задание №11 23.05.24}
...
\allocation{Key Points about the Subjunctive Mood}
...
\subsection*{№4. Choose the best answer a, b, or c for each gap.}
\begin{enumerate}
...
\subsection*{№7. Complete the sentences with the words below. Put them into the correct form.}
...
\section*{№11. Read the sentences below and choose the right option. Translate the sentences into Russian.}
